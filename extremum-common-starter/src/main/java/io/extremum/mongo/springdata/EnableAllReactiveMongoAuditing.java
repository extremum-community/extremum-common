...
/**
 * This is essentially the same thing as @{@link org.springframework.data.mongodb.config.EnableReactiveMongoAuditing},
...
@Import(AllReactiveMongoAuditingRegistrar.class)
public @interface EnableAllReactiveMongoAuditing {
    /**
