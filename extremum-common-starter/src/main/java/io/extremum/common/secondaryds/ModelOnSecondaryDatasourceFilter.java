...
public final class ModelOnSecondaryDatasourceFilter implements TypeFilter {
    @Override
    ...
    private boolean hasModelClassInRepositoryClassGenerics(MetadataReader metadataReader) {
        ...
        return AnnotationUtils.findAnnotation(modelType, SecondaryDatasource.class) != null;
    }
