...
class ReactiveRequestIdControllerAspectTest {
    private final ReactiveRequestIdControllerAspect aspect = new ReactiveRequestIdControllerAspect();
    ...
    void givenControllerMethodReturnsMonoWithResponse_whenApplyingAspect_thenRequestIdShouldBeFilledAndPayloadRemainTheSame() {
        ...
        StepVerifier.create(mono)
                .assertNext(returnedResponse -> {
                    ...
                    assertThat(returnedResponse.getRequestId(), is(notNullValue()));
